...
import Color from "../utils/images/Color.jpg";
      ...
      <div className="bg-white">
        ...
        <section  id="Services" className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
          <div className="mb-12 text-center">
            ...
            <p className="mx-auto mt-4 max-w-xl text-s text-gray-600">
              ...
              return (
                ...
                >
                  <div className="flex h-48 items-center justify-center bg-gray-50">
                    <img src={service.image} alt={service.name} className="h-24 w-24 object-contain" />
                  </div>
                  <div className="p-6">
